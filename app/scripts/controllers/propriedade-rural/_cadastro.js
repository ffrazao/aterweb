...
aterwebApp.controller('PropriedadeRuralCtrl', ['$scope', '$modal_b', 'toastr', '$state', 'ngTableParams', '$http', '$q', 'FrzNavegadorParams', 
...
// TODO pode remover o codigo a seguir, para teste somente
$scope.lista = [{id: 1, nome: 'Teste', filhos: [{id: 3, nome: 'Filho Teste'}, {id: 4, nome: 'Filho Teste'}]}, {id: 2, nome: 'Teste'}];
