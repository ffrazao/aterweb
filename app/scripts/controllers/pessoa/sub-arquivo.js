...
aterwebApp.controller('PessoaArquivoCtrl', ['$scope', 'FrzNavegadorParams', '$modal_b', '$modalInstance', 'toastr',
  ...
  $scope.pessoaArquivoNvg = new FrzNavegadorParams();
  ...
  $scope.especial = function () {
	$scope.pessoaArquivoNvg.especialBotoesVisiveis(['agir', 'editar', 'excluir', 'incluir', 'navegar', 'tamanhoPagina', ]);
  };
  ...
  $scope.incluir = function (size) {
    var modalInstance = $modal_b.open({
      ...
      templateUrl: 'pessoaArquivoFrm.html',
      controller: 'PessoaArquivoCtrl',
      size: size,
      resolve: {
        registro: function () {
