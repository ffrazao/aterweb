...
import gov.emater.aterweb.mvc.dto.IndiceSocialCadFiltroDto;
...
/**
 * Gerencia requisições para Índices de Sociais.
 */
@Controller
@RequestMapping(value = "/" + IndiceSocialController.PAGINA)
public class IndiceSocialController extends _BaseController implements
		CadastroController<EntidadeBase, IndiceSocialCadFiltroDto> {

	private static final Logger logger = Logger
			.getLogger(IndiceSocialController.class);

	public static final String PAGINA = "indice-social-cad";

	public static final String TITULO = "Gestão de Índices Sociais";

	@Autowired
	public IndiceSocialController(PessoaService service) {
		super(service);
	}
	...
	@ResponseBody
	public JsonResponse filtrar(@RequestParam IndiceSocialCadFiltroDto filtro,
	...
	protected void prepararInterno(Map<String, Object> variaveis) {
		variaveis.put(VAR_FILTRO, new IndiceSocialCadFiltroDto());
