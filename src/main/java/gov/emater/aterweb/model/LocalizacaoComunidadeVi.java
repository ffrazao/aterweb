 ...
 */
@Entity
@Table(name = "localizacao_comunidade_vi", schema = EntidadeBase.PESSOA_SCHEMA)
public class LocalizacaoComunidadeVi extends EntidadeBase implements
	...
	public LocalizacaoComunidadeVi() {
	}
