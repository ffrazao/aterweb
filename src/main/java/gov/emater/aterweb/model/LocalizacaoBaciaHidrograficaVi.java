 ...
 */
@Entity
@Table(name = "localizacao_bacia_hidrografica_vi", schema = EntidadeBase.PESSOA_SCHEMA)
public class LocalizacaoBaciaHidrograficaVi extends EntidadeBase implements
	...
	public LocalizacaoBaciaHidrograficaVi() {
	}
